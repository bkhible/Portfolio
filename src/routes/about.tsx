      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-start">
        ...
        <div className="flex-1 pt-2">
          ...
          <div className="space-y-4 text-gray-600 leading-relaxed text-sm md:text-base">
            ...
            <p>
              When I'm not styling spaces, I'm working on my <a href="https://www.etsy.com/shop/groundscorecharmco/" style="color: #4b4b4b;">Etsy shop</a> where I sell small batch charm jewelry, and indulging in photography and travel.
            </p>
          </div>
        </div>
      </div>
